  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      Provider.of<NewsProvider>(context, listen: false).fetchNews().then((_) {
        // After news is fetched, update bookmarks with current articles
        Provider.of<BookmarksProvider>(context, listen: false)
            .setAvailableArticles(Provider.of<NewsProvider>(context, listen: false).newsArticles);
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: RefreshIndicator(
        onRefresh: _refreshNews, // Define the refresh function here
            ...
            : newsProvider.errorMessage != null
                ...
                : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                     ...
                     // final isBookmarked = bookProvider.isBookmarked(article);
                        ...
                        child: InkWell(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => ArticleWebViewPage(url: article.url),
                              ),
                            );
                          },
                          child: Column(
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 8),
                                    Text(article.description, style: TextStyle(color: Colors.grey[700])),
                                    SizedBox(height: 12),
                                    Row(
